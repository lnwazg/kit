...
public class MimeMappingMap
{
    ...
    static
    {
        MimeMappingMap mimeMappingMap = XStreamKit.parseXml2Object(MimeMappingMap.class.getResourceAsStream("mime_mapping.xml"), MimeMappingMap.class);
