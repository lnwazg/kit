...
public final class XmlParser
{
        ...
        throws Exception
    {
        ...
        {
            Logs.info("The xml to be parsed to document object is blank, will exit parseXml2Docment() now!");
            return null;
        }
        try
        {
        ...
        {
            Logs.error("Fail to parse the xml[" + xmlStr + "] to document object.", e);
        ...
        throws Exception
    {
        ...
        {
            Logs.error("Parse xml file['" + filePath + "'] is fail.", e);
    ...
    public static String getValueByTag(Document document, String tagName)
    {
        if (null == document)
        {
            Logs.error("The document object is null.");
        }
        else
        {
