...
import com.lnwazg.kit.file.PathKit;
...
public class QRCodeUtil
{
        ...
        throws Exception
    {
        ...
        QRCodeUtil.encode(text, "c:/code.png", "c:/", true);
    }
     ...
     * @param rsp
     */
    public static void generateQrCode(String url, HttpServletRequest req, HttpServletResponse rsp)
    {
        try
        {
            // 二维码中间的图片
            String imgPath = String.format("%s/images/qrcode/logo.png", PathKit.getRealPath(req));
            // System.out.println("the img path is: " + imgPath);
            BufferedImage image = QRCodeUtil.createImage(url, imgPath, true);
            ImageIO.write(image, FORMAT_NAME, rsp.getOutputStream());
        }
        catch (Exception e)
        {
            e.printStackTrace();
